...
double forward_sub_b(double a, double b, double b_back, double c_back)
{
...
int main()
{
  ...
  for (int i = 1; i<= n-3; i++){
    ...
    b_tilde.at(i) = forward_sub_b(a.at(i),b.at(i), b_tilde.at(i-1), c.at(i-1));
    g_tilde.at(i) = forward_sub_g(a.at(i), b_tilde.at(i-1), f(i*delta_x,h), g_tilde.at(i-1));
  ...
  for (int i = n-4; i >= 0;i--)
  {
    v.at(i) = backward_sub_v(b_tilde.at(i), c.at(i), g_tilde.at(i), v.at(i+1));
  }
